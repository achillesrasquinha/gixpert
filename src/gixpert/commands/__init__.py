...
from gixpert.commands.util 	import cli_format
...
from gixpert 	import cli
from bpyutils._compat		    import builtins, iteritems
from gixpert.__attr__      	import __name__
from gixpert.exception      import DependencyNotFoundError
...
"gixpert". Kindly post an issue at https://github.com/achillesrasquinha/gixpert/issues""", cli.RED))
        else:
            raise e
